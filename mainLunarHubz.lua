--[[
Nếu có trường hợp bị lỗi thì hãy liên hệ admin : https://www.facebook.com/dtq.24thg9
]]--
...
ImageButton1.Image = "rbxassetid://16161921825"
...
local Library = Update:Window("TQuoc.zZ","",Enum.KeyCode.RightControl);
...
H:AddLabel("Code by admin")

H:AddLabel("Box Dis")
H:AddLabel("chưa có")
H:AddLabel("Discord: có cái lồn")
 

H:AddButton("Facebook Admin",function()
setclipboard("https://www.facebook.com/dtq.24thg9")
